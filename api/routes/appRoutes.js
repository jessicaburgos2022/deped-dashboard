...
const { listOutputTypeId, listKRAByDepartmentId, listProjectByKRAId, listProjectsByDepartmentId, listDepartment, listOutcomeType } = require('../controller/appController');
